...
const Effect = () => {
  ...
  return (
    <>
    <h2>{count}</h2>
    <button className='btn btn-primary' onClick={()=>setCount(1+count)}>Increment by 1</button>
    <hr/>
    <h2>{num}</h2>
    <button className='btn btn-success' onClick={()=>setNum(3+num)}>Increment by 3</button>
    </>
  )
}
